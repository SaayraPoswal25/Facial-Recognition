...
#         if encode:  # Ensure a face encoding exists
#             encodeList.append(encode[0])
#     return encodeList

# last_attendance_time = datetime.now() - timedelta(seconds=20)

# def markAttendance(name):
#     global last_attendance_time
#     current_time = datetime.now()

#     # Check if 30 seconds have passed since the last recorded attendance
#     if current_time - last_attendance_time < timedelta(seconds=30):
#         return  # Skip marking attendance if within 30 seconds
